...
<body>
    ...
    <div class="mainFlex">
        ...
        <button type: "button" onclick="showAdvancedSearch()">Restrict by Date Range </button>
                   ...
                   */
                    ...
                    // TESTING THE SORT FUNCTION
                        ...
                        switch($sort) {
                            ...
                            case "Date":
                               $raw_results = mysqli_query($db, "SELECT * FROM Article WHERE IsSubmitted = 1 AND IsDraft = 0 AND (PublishDate BETWEEN '$query2' AND '$query3') ORDER BY Views DESC") or die(mysql_error());
                                echo "<div class='search-content'>";
                                if(mysqli_num_rows($raw_results) > 0){ 
                                    while($results = mysqli_fetch_array($raw_results)){
                                        print   "<div class='flexRow'>
