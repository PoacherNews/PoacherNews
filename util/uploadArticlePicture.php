...
$target_dir = "/Users/rro2q2/Desktop/PoacherNews/res/img/articlePictures/".$_SESSION['userid']."/";

if (!file_exists("/Users/rro2q2/Desktop/PoacherNews/res/img/articlePictures/".$_SESSION['userid']."")) {
    mkdir("/Users/rro2q2/Desktop/PoacherNews/res/img/articlePictures/".$_SESSION['userid']."", 0777, true);
}

chmod($target_dir, 0777);

$target_file = $target_dir . basename($_FILES["articlePicture"]["name"]);
$Filename=basename( $_FILES["articlePicture"]["name"]);
$uploadOk = 1;
...
// if everything is ok, try to upload file
    ...
    // prepare
    if (!$stmt_users->prepare("UPDATE User SET ArticleImage = '".$Filename."' WHERE ArticleID = ?"))
    {
    ...
    echo "The file ". basename( $_FILES["articlePicture"]["name"]). " has been uploaded.";
    // $_SESSION UPDATE
